...
if not GeminiConfigGUIMultiLineEditBoxInsertLink then
    -- upgradeable hook
    --hooksecurefunc("ChatEdit_InsertLink", function(...) return _G.GeminiConfigGUIMultiLineEditBoxInsertLink(...) end)
end

function _G.GeminiConfigGUIMultiLineEditBoxInsertLink(text)
...
local function Constructor()
    ...
    local widgetNum = GeminiConfigGUI:GetNextWidgetNum(Type)
