...
local tGeminiWindowDef = {
   ...
   Children = {
      ...
      },
      {
         ...
         BGColor = "white", 
         TextColor = "white", 
         Sprite = "CRB_Basekit:kitFooter_MetalGold_Square", 
         Picture = true, 
         IgnoreMouse = true, 
         Pixies = {
            { AnchorOffsets = { 148, 11, -10, -9 }, AnchorPoints = { 0, 0, 1, 1 }, Sprite = "BK3:UI_BK3_Metal_Inset_SharpCorner", BGColor = "white", TextColor = "black", },
         },
         Children = {
            {
